...
def initial_beta_function(beta):
    ...
    result = -n / (sum(covariate_data) + log_multiplication_term) - beta
...
def experiment(iterations, dataset_string, model_string, cov_string):
    ...
    row = [dataset_string, model_string, cov_string,b0, beta0, b, betas, np.mean(np.array(time_list)), llfVal, converged]
...
if __name__ == "__main__":
    ...
    filename = 'results/exp_GM_EM_one_cov_3.csv'
